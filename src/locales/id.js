export const id = {
  ...
  hero: {
    ...
    bio: 'Saya membangun pengalaman digital melalui kode, rasa ingin tahu, dan eksplorasi tanpa henti.',
    basedInLabel: 'BERBASIS DI',
    location: 'Klaten, Jawa Tengah',
    country: 'Indonesia',
    openForLabel: 'TERBUKA UNTUK',
    openForValue: 'Peluang baru dan kolaborasi menarik',
    viewCv: 'LIHAT CV',
  ...
  about: {
    ...
    values: {
      process: {
        ...
        description: 'Saya fokus pada proses yang benar untuk hasil yang berkelanjutan.'
      },
      collaborative: {
        title: 'Kolaboratif',
        description: 'Saya percaya proses terbaik lahir dari kerja sama dan komunikasi.'
      },
      structured: {
        title: 'Terstruktur',
        description: 'Saya percaya perencanaan yang baik menghasilkan solusi yang tepat.'
      },
      learning: {
        title: 'Selalu Belajar',
        description: 'Teknologi berubah cepat, saya memilih untuk terus berkembang.'
      }
    }
  },
  projects: {
